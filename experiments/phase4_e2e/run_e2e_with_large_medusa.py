#!/usr/bin/env python3
"""Run end-to-end evaluation with the large-trained Medusa checkpoint.

Usage:
    CUDA_VISIBLE_DEVICES=2 python experiments/phase4_e2e/run_e2e_with_large_medusa.py
"""
...
import run_medusa_e2e_comparison as e2e_module
...
e2e_module.E2EConfig.medusa_checkpoint_path = str(PROJECT_ROOT / "checkpoints/medusa_large/medusa_best.pt")
e2e_module.E2EConfig.output_dir = str(PROJECT_ROOT / "results/phase4_medusa_large")
